...
Funcionalidade: Configuração e inserção de produto no carrinho
        ...
        Cenário: Inserir produto no carrinho com seleções de cor, tamanho e quantidade obrigatórias
             Quando estou na página de configuração do produto
              E faço as seleções obrigatórios clicando no botão "Comprar"
